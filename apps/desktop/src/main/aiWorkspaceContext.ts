...
export function aiWorkspaceContext(root: string | null, blocker: string | null): string {
  ...
  return [
    ...
    "The workspace is already selected. Do not ask the user for its path. Use list_files with no path to inspect its root; use relative paths with read_file and propose_edit. propose_edit can create new files.",
