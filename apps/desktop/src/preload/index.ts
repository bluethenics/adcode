...
const api: AdcodeApi = {
  ...
  terminal: {
    ...
    openLink: (url) => ipcRenderer.invoke(CHANNELS.terminalOpenLink, url),
  ...
  ai: {
    ...
    inlineEdit: (input) => ipcRenderer.invoke(CHANNELS.aiInlineEdit, input),
    cancelInlineEdit: () => ipcRenderer.send(CHANNELS.aiCancelInlineEdit),
  ...
  git: {
    ...
    openGitHub: (remote, destination) => ipcRenderer.invoke(CHANNELS.gitOpenGitHub, remote, destination),
