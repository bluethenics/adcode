...
export const DOC_SEED: readonly DocSeed[] = [
  ...
  },
  {
    ...
    section: "The workbench",
    description: "Send the current editor selection or buffer into your assistant's composer.",
    ...
    keywords: ["Ask AI about your code", "The workbench", "selection", "assistant", "unsaved code", "AI context"],
    access: ["All Features → Ask AI about your code", "Ask AI (command:ai.askSelection)", "Explain (command:ai.explainSelection)", "Refactor (command:ai.refactorSelection)", "Write tests (command:ai.testSelection)", "Find issues (command:ai.reviewSelection)"],
