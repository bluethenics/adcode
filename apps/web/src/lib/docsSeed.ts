...
export const DOC_SEED: readonly DocSeed[] = [
  ...
  },
  {
    ...
    description: "A spacious conversation workspace with searchable history and a panel for agents, tasks, and live activity.",
  ...
  },
  {
    ...
    section: "The assistant",
    description: "Connect an AI provider or save several named API connections with a model, secure key, and requests-per-minute limit, including NVIDIA NIM.",
