...
export const DOC_SEED: readonly DocSeed[] = [
  {
    ...
    how: "Off by default, so Enter always starts a new line. Turn it on and Enter takes the highlighted suggestion; Tab still takes the suggestion either way.",
  ...
  },
  {
    ...
    how: "Off by default, so the editor stays quiet unless you ask. Turn it on and the message is dimmed and shortened so it never covers your code, and it hides itself on the line your cursor is on while you type.",
  ...
  },
  {
    ...
    how: "Off by default. Turn it on, then drag the highlighted box to scroll, or click anywhere on it to jump there.",
  ...
  },
  {
    ...
    how: "Off by default. Turn it on, then click a stuck line at the top to jump back to it.",
  ...
  },
  {
    ...
    description: "A spacious conversation workspace with searchable history, a live thinking-and-working block per answer, code blocks you can copy, and per-response Copy, Retry, and feedback.",
    ...
    keywords: ["AI chat workspace", "The assistant"],
    access: ["All Features → AI chat workspace", "Turn on or off (setting:adcode.ai.chatWidget)", "Settings → adcode.ai.chatWidget"],
  ...
  },
  {
    ...
    title: "AI Team",
    section: "The assistant",
    description: "Create named agents with their own instructions and models, then let a team divide a task and bring its results back for review.",
    ...
    keywords: ["AI Team", "The assistant", "multiple ai", "parallel agents", "divide task", "roles", "named agents", "agent profiles", "team activity", "agent instructions"],
    access: ["All Features → AI Team", "Set up Team (command:ai.team)", "Settings → adcode.ai.agentProfiles"],
  ...
  },
  {
    ...
    section: "The assistant",
    description: "Every conversation is kept in Today, Yesterday, and older groups, so you can go back to one. A strip at the top shows exactly what the assistant is remembering right now, and a button clears it.",
  ...
  },
  {
    ...
    section: "The assistant",
    description: "Connect an AI provider in three steps - choose a provider, check and save its key, pick a model - or save several named API connections with a requests-per-minute limit, including NVIDIA NIM.",
    ...
    keywords: ["Connect a model", "The assistant", "api key", "provider", "model", "local ai", "NVIDIA NIM", "custom endpoint", "connections", "requests per minute", "RPM", "rate limit", "429"],
    access: ["All Features → Connect a model", "Connect (command:ai.connect)", "Settings → adcode.ai.connections"],
    related: ["ai-provider", "ai-model", "ai-sessions", "ai-team"],
  },
  {
    ...
    keywords: ["Continue terminal AI after limits", "The assistant", "usage limit", "rate limit", "resume after limit", "keep going", "unattended", "grok", "kimi", "codex", "claude code"],
    access: ["All Features → Continue terminal AI after limits", "Turn continuation on or off (command:ai.autoContinue)", "Turn on or off (setting:adcode.ai.autoContinue)", "Settings → adcode.ai.autoContinue", "Settings → adcode.ai.autoContinueRetries"],
  ...
  },
  {
    ...
    title: "Edit with AI",
    section: "The assistant",
    description: "Select code, press Ctrl+E and say what to change. The rewrite appears in place, highlighted green under the struck-out original, for you to accept or reject.",
    ...
    shortcut: "Ctrl+E",
    keywords: ["Edit with AI", "The assistant", "ctrl+e", "inline edit", "cmd+k", "ctrl+k", "rewrite selection", "inline chat", "edit in place", "ai refactor", "generate code here"],
    access: ["All Features → Edit with AI", "Edit with AI (command:ai.inlineEdit)", "Keyboard → Ctrl+E"],
    related: ["workbench-ai-context", "ai-inline-completion", "ai-connect"],
  },
  {
  ...
  },
  {
    ...
    access: ["All Features → Model", "Settings → adcode.ai.model", "Settings → adcode.ai.effort"],
  ...
  {
    slug: "ai-composer-commands",
    title: "Slash commands and @ files",
    section: "The assistant",
    description: "Type / in the assistant's composer for ready-made commands like /review and /test, or @ to put any project file in the conversation.",
    ...
    keywords: ["Slash commands and @ files", "The assistant", "slash commands", "review my changes", "commit message", "write tests", "mention a file", "at mention", "@file", "prompt history", "previous prompt"],
    access: ["All Features → Slash commands and @ files", "Show commands (command:ai.slashCommands)", "Add a file (command:ai.mentionFile)"],
    related: ["ai-chat-widget", "workbench-ai-context", "ai-inline-edit"],
  },
  {
    slug: "ai-task-token-budget",
    title: "Task token budget",
    section: "The assistant",
    description: "Optionally sets a hard ceiling for one assistant task, checked before each new request can spend your key.",
  ...
  {
    slug: "ai-terminal-team",
    title: "Team in the terminal",
    section: "The assistant",
    description: "Split one task across several agent CLIs - Claude Code, Codex, Grok, Kimi and the rest - each working in its own terminal pane.",
    why: "You already pay for more than one of these, and they are good at different things. Running them one after another wastes the ones that are idle; running them by hand means writing the same briefing four times and watching four panes to see who has finished.",
    how: "Right-click a terminal and choose Start a Team here, or run Set Up AI Team. Describe the task, then pick which CLI takes which role. ADCode opens a pane per role, starts that CLI, and briefs it with its own piece, the acceptance criteria, and what its teammates have already finished. A task only starts once everything it depends on has reported done. Each agent is asked to print one line when it finishes; an agent that goes quiet for five minutes is treated as finished instead. Nothing is sandboxed - these are your CLIs editing your working tree, which is why you confirm the plan first. Closing a pane fails just that task and leaves the others running.",
    keywords: ["Team in the terminal", "The assistant", "grok", "kimi", "codex", "claude code", "gemini cli", "cursor agent", "qwen", "amp", "goose", "crush", "droid", "external cli", "several agents at once", "split a task between clis"],
    access: ["All Features → Team in the terminal", "Start a Team in the terminal (command:ai.terminalTeam)"],
    related: ["ai-team", "ai-terminal-agent-detection", "ai-auto-continue"],
  },
  {
    ...
    keywords: ["Terminal agent detection", "The assistant", "recognise agent", "detect cli", "grok", "kimi", "codex", "share memory with agent"],
  ...
  {
    slug: "workbench-ai-context",
    title: "Ask AI about your code",
    section: "The workbench",
    description: "The assistant already sees the file you are on, your cursor, your selection and the editor's errors. Ctrl+L adds a selection to the conversation as a chip.",
    ...
    shortcut: "Ctrl+L",
    keywords: ["Ask AI about your code", "The workbench", "selection", "assistant", "unsaved code", "AI context", "ctrl+l", "add to chat", "editor context", "current file", "what the ai sees"],
    access: ["All Features → Ask AI about your code", "Add to chat (command:ai.addSelectionToChat)", "Ask AI (command:ai.askSelection)", "Explain (command:ai.explainSelection)", "Refactor (command:ai.refactorSelection)", "Write tests (command:ai.testSelection)", "Find issues (command:ai.reviewSelection)", "Keyboard → Ctrl+L"],
    related: ["workbench-modes", "ai-inline-edit", "ai-composer-commands"],
  },
  {
  ...
  {
    slug: "workbench-modes",
    title: "Vibe and Code modes",
    section: "The workbench",
    description: "Two ways to work with one project: conversation first in Vibe, editor first in Code.",
    ...
    keywords: ["Vibe and Code modes", "The workbench", "vibe mode", "code mode", "workspace", "build", "review", "task history"],
    access: ["All Features → Vibe and Code modes", "Vibe (command:workspace.vibe)", "Code (command:workspace.code)", "Project (command:workspace.project)", "Changes (command:workspace.changes)", "Tasks (command:workspace.tasks)", "Preview (command:workspace.preview)"],
    related: ["workbench-ai-context", "workbench-all-features"],
  },
  {
    slug: "appearance-theme",
    title: "Appearance",
    section: "Appearance",
    description: "Warm light, charcoal dark, or midnight. System follows your computer's appearance.",
